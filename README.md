...
| 功能 | 说明 | 频率 |
|------|------|------|
| **📋 待办提取** | 扫描私聊，识别承诺和任务，推送到 Discord Forum | 每 30 分钟 |
...
<p align="center">
  <img src="assets/forum.png" alt="forum" width="800">
</p>

所有输出统一推送到一个 **Discord Forum 频道**，通过 tag 分类（📋待办 / 📅日程 / 📰干货）：

- **待办** — 每个新待办创建一个帖子，后续回扫微信对话检测完成信号（"搞定了"、"已处理"），超过 7 天未完成自动催促，完成后关帖
- **日程** — 创建帖子 + Apple Calendar 事件，日程到期自动关帖
- **干货** — 每日一帖，按群分组，精选 Top 3 置顶

> 不再是消息流一滚就找不到了——每条待办都有独立帖子，状态可追踪。
